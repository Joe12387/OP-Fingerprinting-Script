...
var fingerprint = function () {
    ...
    return new Promise(function (resolve) {
        var fingerprints = {
            ...
            canvasAPI: function () {
                return new Promise(function (resolve) {
                    if ((isSafari() && navigator.maxTouchPoints !== undefined) || isBrave())
                        resolve(0);
                    ...
                    function font_test(font) {
                        return new Promise(function (resolve, reject) {
                            ...
                            for (var index_1 in baseFonts) {
                                span.style.fontFamily = font + ',' + baseFonts[index_1];
                                body.appendChild(span);
                                detected = (span.offsetWidth != defaultWidth[baseFonts[index_1]] || span.offsetHeight != defaultHeight[baseFonts[index_1]]);
                                body.removeChild(span);
                                if (detected) {
