            ...
            fonts: function () {
                return new Promise(function (resolve) {
                    return __awaiter(this, void 0, void 0, function () {
                        ...
                        var fontMode, fontList, list, baseFonts, body, span, defaultWidth, defaultHeight, index_2, dfonts, fi;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    if (isBrave())
                                        resolve([-1, null]);
                                    fontMode = (isSafari() && !isFirefox()) || isMSIE();
                                    ...
                                    defaultWidth = {};
                                    defaultHeight = {};
                                    for (index_2 in baseFonts) {
                                        span.style.fontFamily = baseFonts[index_2];
                                        body.appendChild(span);
                                        defaultWidth[baseFonts[index_2]] = span.offsetWidth;
                                        defaultHeight[baseFonts[index_2]] = span.offsetHeight;
                                        body.removeChild(span);
                                    }
                                    dfonts = [];
                                    for (fi = 0; fi < fontList.length; fi++) {
                                        font_test(fontList[fi]).then(function (promise) {
                                            dfonts.push(promise);
                                        });
                                    }
                                    return [4 /*yield*/, Promise.all(dfonts)];
                                case 1:
                                    _a.sent();
                                    resolve([0, list.sort()]);
                                    return [2 /*return*/];
