var fingerprint = function() {
  ...
  return new Promise(function(resolve) {
    var fingerprints = {
      ...
      colorGamut: function() {
        return new Promise(function(resolve) {
          var colorGamuts = ["rec2020", "p3", "srgb"], gamut;
      ...
      timezone: function() {
        return new Promise(function(resolve) {
          ...
          var utc = -Math.max(parseFloat(new Date(year, 0, 1).getTimezoneOffset()), parseFloat(new Date(year, 6, 1).getTimezoneOffset()));
      ...
      webglInfo: function() {
        return new Promise(function(resolve) {
          ...
          try {
            var context = canvas.getContext("webgl") || canvas.getContext("experimental-webgl") || resolve(0);
          } catch (e) {
            resolve(0);
          }
