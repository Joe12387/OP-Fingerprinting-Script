    ...
    return new Promise(function(resolve) {
      var fingerprints = {
        ...
        maxTouchPoints: function() {
          var n = navigator;
          return Promise.resolve(n.maxTouchPoints !== undefined ? n.maxTouchPoints : (n as any).msMaxTouchPoints !== undefined ? (n as any).msMaxTouchPoints : -1);
        },
        cpuClass: function() {
        ...
        monochrome: function() {
          return new Promise(function(resolve) {
            if (matchMedia("(min-monochrome: 0)").matches) {
              for (var i = 0; i <= 100; ++i) {
                if (matchMedia("(max-monochrome: " + i + ")").matches) resolve(i);
        ...
        timezone: function() {
          return new Promise(function(resolve) {
            ...
            const utc = -Math.max(parseFloat((new Date as any)(year, 0, 1).getTimezoneOffset()), parseFloat((new Date as any)(year, 6, 1).getTimezoneOffset()));
        ...
        timezoneOffset: function() {
          return new Promise(function(resolve) {
            const year = (new Date).getFullYear();
            resolve(-Math.max(parseFloat((new Date as any)(year, 0, 1).getTimezoneOffset()), parseFloat((new Date as any)(year, 6, 1).getTimezoneOffset())));
          });
        },
        language: function() {
          return new Promise(function(resolve) {
        ...
        jsHeapSizeLimit: function() {
          return new Promise(function(resolve) {
            var perf, memory, jsHeapSizeLimit;
            if ((perf = window.performance) != undefined) {
              if ((memory = perf.memory) != undefined) {
                if ((jsHeapSizeLimit = memory.jsHeapSizeLimit) != undefined) {
        ...
        audioContext: function() {
          return new Promise(function(resolve) {
            ...
            if (typeof context !== "function") resolve(-1);
            ...
            var pxi_compressor = (context as any).createDynamicsCompressor();
            ...
            (context as any).oncomplete = function(evnt) {
              var pxi_output = 0;
        ...
        userAgentData: function() {
          return new Promise(function(resolve) {
            ...
            if (!uad || typeof uad.getHighEntropyValues !== "function") resolve(-1);
        ...
        canvasAPI: function() {
          return new Promise(function(resolve) {
            ...
            function canvas_geometry(ctx: any) {
        ...
        applePay: function() {
          return new Promise(function(resolve) {
            var ap = (window as any).ApplePaySession;
            if (typeof ap !== "function") resolve(-1);
            var enabled = ap.canMakePayments();
            resolve(enabled);
          });
        },
        ...
        webglInfo: function() {
          return new Promise(function(resolve) {
            ...
            try {
              let context = canvas.getContext("webgl") as any || canvas.getContext("experimental-webgl") as any || resolve(0);
            } catch (e) {
              resolve(0);
            }
        ...
        webglProgram: function() {
          return new Promise(function(resolve) {
            ...
            try {
              var context = canvas.getContext("webgl") as any || canvas.getContext("experimental-webgl") as any || resolve(-1);
            } catch (e) {
              resolve(-2);
            }
        ...
        fonts: function() {
          return new Promise(function(resolve) {
            ...
            function font_test(font: string) {
            ...
            for (var fi = 0; fi < fontList.length; fi++) {
              font_test(fontList[fi]).then(function() {
                dfonts.push(promise);
              });
            }
        ...
        plugins: function() {
          return new Promise(function(resolve) {
            ...
            var plugins = (navigator as any).plugins;
            var output = [] as any;
            if (plugins) {
      ...
      Promise.all(promises).then(function(k) {
        ...
        resolve({profile: profile, fingerprint: murmurhash3_32_gc(JSON.stringify(profile), 420)});
      });
    });
  };